...
import static ru.bellintegrator.utils.PropConst.*;
...
public class DriverManager {
     ...
     *
     * @param gecko  - переменная firefox из файла application.properties в классе {@link ru.bellintegrator.utils.PropConst}
     * @param chrome - переменная chrome из файла application.properties в классе {@link ru.bellintegrator.utils.PropConst}
     */
